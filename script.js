...
=======
      ...
      /**
       * Тут есть подвох)
       * Если мы днем достигли N но нам не стоит ожидать
       * ночь пока опустится блок - мы уже подняли его
       *
       * Стоит првым делом поднять блок, потом проверить условие
       * и только если мы не достигли N опускать его ночью и заходить
       * на новую итерацию/сутки
       */
>>>>>>> c398831aa358873db2de9e7a9fe6d1af69a656f7
      result++;
      if(i===N){
        break;
      }else{
...
=======
      ...
      /**
       * Тут еще default стоит добавить
       * Для трех случаев, когда выбрано евро-евро, например.
       */
>>>>>>> c398831aa358873db2de9e7a9fe6d1af69a656f7
  }
